...
<head>
    ...
    <meta name="author" content="Andryhsm et Stian">
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>Medsoft-sante</b></a>
            </div>
        ...
        <div id="c">
            <div class="container">
                <p>
                    ...
                    <br/>
                    Pratt Landing Page PROVA {{ trans('adminlte_lang::message.createdby') }} <a href="http://www.blacktie.co">Msoft Madagascar</a>
                </p>
